...
const api: DashApi = {
  ...
  git: {
    ...
    stashList: (args: GitTabRef) => ipcRenderer.invoke(IPC.GitStashList, args),
    stashPush: (args: GitStashPushArgs) => ipcRenderer.invoke(IPC.GitStashPush, args),
    stashApply: (args: GitStashWriteArgs) => ipcRenderer.invoke(IPC.GitStashApply, args),
    stashPop: (args: GitStashWriteArgs) => ipcRenderer.invoke(IPC.GitStashPop, args),
    stashDrop: (args: GitStashWriteArgs) => ipcRenderer.invoke(IPC.GitStashDrop, args),
    stashShowFiles: (args: GitStashShowFilesArgs) =>
      ipcRenderer.invoke(IPC.GitStashShowFiles, args),
